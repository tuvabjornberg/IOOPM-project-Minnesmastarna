...
{
    ioopm_store_t *new_store = allocate_array(STORAGE_INITIAL_CAPACITY, sizeof(ioopm_store_t), store_destructor); //TODO: allocate_array
...
// TODO: Change this in accordance with list-destroy
{
